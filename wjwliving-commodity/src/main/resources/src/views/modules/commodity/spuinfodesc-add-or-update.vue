<template>
  <el-dialog
    ...
    <el-form-item label="商品介绍图片" prop="description">
      <el-input v-model="dataForm.description" placeholder="商品介绍图片"></el-input>
    </el-form-item>
    </el-form>
        ...
        this.$nextTick(() => {
          ...
          if (this.dataForm.spuId) {
            this.$http({
              ...
              if (data && data.code === 0) {
                this.dataForm.description = data.spuInfoDesc.description
              }
            })
          }
        })
